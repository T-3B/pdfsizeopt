...
--use-zlib-optimizer=CMD_PATTERN
  ...
  zlib embedded in PDF. Very small gains, less than 0.1%!
  Can be slow as pdfsizeopt decompresses & compresses the same object 2~3 times.
  CMD_PATTERN is an os.system command-line pattern, which
